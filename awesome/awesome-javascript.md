...
- **asdf** Универсальный контекстный менеджер версий с открытым исходным кодом, позволяющий через единый интерфейс командной строки и систему плагинов управлять рантаймами множества языков программирования на уровне отдельных проектов. https://asdf-vm.com/
...
- Основы
  ...
  - libuv
    ...
    - Событийный цикл, библиотека libUV https://imnotgenius.com/21-sobytijnyj-tsikl-biblioteka-libuv/
