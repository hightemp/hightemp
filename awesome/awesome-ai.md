...
- Появился MCP-плагин OpenMemory, который объединяет память Cursor, Claude, Windsurf и любых MCP! Он сохраняет 100% инфы из всех тулз и сеансов в одно место. https://github.com/mem0ai/mem0/tree/main/openmemory
