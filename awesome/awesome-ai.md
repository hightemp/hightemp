...
- Гайд по промптам для ChatGPT 5.1 — официальное руководство OpenAI с советами, стратегиями и примерами идеальных запросов для повышения точности и скорости ответов модели. https://cookbook.openai.com/examples/gpt-5/gpt-5-1_prompting_guide
