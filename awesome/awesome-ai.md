...
- Qoder — бесплатный ИИ-агент от Alibaba, способный писать код и собирать приложения, анализируя проект и кодовую базу, подстраиваясь под стиль написания и выполняя задачи поэтапно. https://qoder.com/
