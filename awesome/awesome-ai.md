...
- Новая папка с 40+ статьями от авторов топовых IT-каналов - коллекция статей по таким темам, как разработка, аналитика данных и поиск работы в сфере информационных технологий, с экспертным контентом от известных авторов тематических каналов. https://t.me/addlist/MzJcelsuvQxhNzUy, https://t.me/notboring_tech/2717
