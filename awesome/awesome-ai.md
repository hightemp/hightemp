...
- Frames - генератор изображений, который отличается контролем стиля и визуальной точностью, создает целый уникальный мир в единой стилистике с множеством предустановленных пресетов и требует платной подписки от $95/мес для использования. http://runwayml.com/
