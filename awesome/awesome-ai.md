...
- Qwen3.5-9B-Uncensored-HauhauCS-Aggressive — Apache-2.0 GGUF-версия Qwen3.5-9B с жёстко снятыми refusal/safety-фильтрами; автор заявляет 0/465 refusals и сохранение возможностей базовой модели. Поддерживает text/image/video, 201 язык, 262K native context, кванты BF16/Q8/Q6/Q4_K_M размером примерно 5.3–17 GB и запуск через llama.cpp, LM Studio, Jan, koboldcpp и совместимые runtime. Использовать только в контролируемой среде: модель специально публикуется без стандартных safety-ограничений. https://huggingface.co/HauhauCS/Qwen3.5-9B-Uncensored-HauhauCS-Aggressive
...
- VideoLingo — open-source all-in-one инструмент для перевода, локализации и озвучки видео, создающий «Netflix‑качества» однострочные субтитры и дубляж с помощью WhisperX, NLP/LLM и TTS-интеграций. https://github.com/Huanshere/VideoLingo https://videolingo.io
