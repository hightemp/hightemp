...
- Firecrawl — это сервис и open‑source платформа, которая по URL обходит сайт, скрапит его страницы и превращает сырой веб‑контент в чистые, структурированные данные (Markdown/JSON), готовые для использования в LLM и аналитике. https://www.firecrawl.dev/
- https://apify.com/
...
- Anti-bot bypass
    ...
    - Автоматизация рутины на hh.ru: Как мы учили Headless Chrome притворяться живым человеком (RPA против Anti-Fraud) https://habr.com/ru/articles/983318/
- TLS Fingerprint
