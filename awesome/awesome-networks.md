...
- Компьютерные сети. Принципы, технологии, протоколы: Юбилейное издание
    - Авторы:
        ...
        - Н. А. Олифер
    - Ссылки:
        - https://www.piter.com/product/kompyuternye-seti-printsipy-tehnologii-protokoly-yubileynoe-izdanie
...
- Электронная почта
    - Как работает электронная почта. База — разбор DNS/MX, SMTP, SPF, DKIM, DMARC, типовой схемы почтового сервера и распространённых ошибок конфигурации. https://habr.com/ru/articles/909760/
- Ethernet
