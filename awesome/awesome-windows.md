...
- Win11Debloat — это легкий и простой в использовании PowerShell-скрипт для удаления предустановленных приложений, отключения телеметрии и навязчивых элементов интерфейса, а также оптимизации и кастомизации Windows 10/11. https://github.com/Raphire/Win11Debloat

### Чистильщики

- FluentCleaner — WinUI 3 чистильщик для Windows 10/11, который удаляет кэши, временные файлы, логи и следы приложений по winapp2.ini-сигнатурам; поддерживает собственные базы правил, сохранённый выбор для запуска через `/AUTO`/Task Scheduler и логирование удалённых путей. https://github.com/builtbybel/FluentCleaner
