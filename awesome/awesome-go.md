...
- Проект "Standard Go Project Layout" представляет собой базовую структуру для организации Go-приложений, включающую общепринятые шаблоны расположения файлов и директорий, а также рекомендации по структурированию кода для эффективной разработки масштабируемых приложений на Go. https://github.com/golang-standards/project-layout
