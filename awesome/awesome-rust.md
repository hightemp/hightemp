...
- Интеграции
  ...
  - cbindgen — генератор C- и C++11-заголовков для Rust-библиотек с публичным C API; работает как отдельный CLI или библиотека из `build.rs` и строит заголовки по определениям из Rust-кода. https://github.com/mozilla/cbindgen
...
- RustTraining от Microsoft - набор mdBook-курсов по Rust для разных уровней и бэкграундов: Rust for C/C++/C#/Python Programmers, Async Rust, Rust Patterns, Type-Driven Correctness и Rust Engineering Practices; покрывает async в продакшене, concurrency/runtime, `no_std`, unsafe, phantom types, state machines, системное программирование, CI/CD и production-readiness. https://github.com/microsoft/RustTraining/ https://microsoft.github.io/RustTraining/
...
- Безопасность
  ...
  - Разборы уязвимостей
    ...
    - Memory-Amplification DoS in the `buffa` Library — attacker-controlled protobuf fields и многократное heap amplification. https://www.endorlabs.com/learn/endor-labs-ai-sast-finds-zero-day-cve-2026-55407-buffa
    - CVE-2026-5222: Cargo Registry Credential Disclosure — ошибочная нормализация sparse registry URLs и утечка authentication token. https://blog.rust-lang.org/2026/05/25/cve-2026-5222/
...
- Память; Типы
  - Визуализация использования памяти для типов в Rust https://vkvideo.ru/video-228916121_456239018 https://www.youtube.com/watch?v=7_o-YRxf_cc
- Обучающие видео
