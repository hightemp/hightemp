...
- talk-normal — репозиторий с системным промптом и наборами skill-инструкций, которые переписывают типичный «нейросетевой» стиль в более прямой, естественный и авторский: убирают воду, клише, шаблонные конструкции и избыточную корпоративную подачу, сохраняя смысл исходного текста. https://github.com/hexiecs/talk-normal
