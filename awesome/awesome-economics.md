...
### Приложения для налоговой отчетности

- https://npd.nalog.ru/app/

### Сервисы

- Snowball Income — это сервис для учета и аналитики инвестиций, который позволяет объединить все активы в одном месте, автоматически загружать отчеты от брокеров и детально отслеживать дивиденды, доходность и диверсификацию портфеля. https://snowball-income.com
