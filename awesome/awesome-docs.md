...
- RapiDoc — Web Component для просмотра Swagger 2.0 и OpenAPI 3.x спецификаций: умеет рендерить интерактивную API-документацию, выполнять API-вызовы прямо из интерфейса, встраиваться в любой HTML или фронтенд-фреймворк и глубоко настраиваться по теме, брендингу и layout. https://github.com/rapi-doc/RapiDoc
