...
- Аналог Notion https://zametker.ru/

## Шаринг файлов, документов
...
- Open-SLUM - это платформа, предоставляющая доступ к «теневым библиотекам» - компьютерным серверам с пиратскими копиями англоязычных научных статей и книг. http://open-slum.org
...
- Crunchbase — это глобальная платформа для поиска бизнес-информации о компаниях, которая предоставляет всеобъемлющую базу данных о частных и государственных организациях. https://www.crunchbase.com/
- Поиск обучающих материалов по теме https://ytclass.co/
...
- Floor796 — интерактивная анимированная сцена, изображающая жизнь персонажей из фильмов, сериалов, игр, аниме и мемов на 796‑м этаже гигантской космической станции; проект создаётся одним автором как хобби с 2018 года, регулярно пополняется новыми комнатами и героями, а почти все персонажи кликабельны и сопровождаются справочной информацией. https://floor796.com/
- Space DJ — веб-эксперимент, где вы пилотируете корабль между звёздами музыкальных стилей, а нейросеть в реальном времени микширует трек из жанров рядом пролетаемых звёзд; рассчитан на запуск с компьютера. https://magenta.withgoogle.com/spacedj-announce https://spacedj-363947264390.us-west1.run.app