...
- Подключить Give Me Public, чтобы он сам вёл нужные каналы в телеге и ВК. Что и когда будет выходить — решает автор канала. После настройки сервис может работать без помощи человека, автономно. https://productradar.ru/product/give-me-public/
