...
- AI
  ...
  - octocode.nvim — Neovim-плагин для семантического поиска по кодовой базе через `octocode` CLI: понимает natural-language запросы, умеет искать отдельно по коду, документации и тексту, автоматически индексирует проект в фоне и открывает результаты прямо в редакторе. https://github.com/muvon/octocode.nvim

### Поиск по файлам

- fff.nvim — это самый быстрый и точный инструментарий для поиска файлов, предназначенный для AI-агентов, Neovim, Rust, C и Node.js, реализованный преимущественно на Rust. https://github.com/dmtrKovalenko/fff.nvim
