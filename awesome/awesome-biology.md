...
- Human Protein Atlas — открытая научная база данных и портал, который собирает и показывает, где и как человеческие белки экспрессируются в клетках, тканях и органах с использованием разных омиксных технологий и визуализации. https://www.proteinatlas.org/
