...
- Shannon Lite — автономный white-box AI-пентестер для веб‑приложений и API, который анализирует исходный код, находит векторы атак и подтверждает уязвимости реальными PoC‑эксплойтами при запуске из CLI. https://github.com/KeygraphHQ/shannon https://github.com/KeygraphHQ/shannon/discussions/249 https://keygraph.io/
