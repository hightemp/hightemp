...
- DorkSearch (https://dorksearch.com/) — конструктор продвинутых поисковых запросов для поиска доменов, поддоменов, email-адресов, пользователей и файлов в открытом доступе.
- Advangle (https://advangle.com/) — визуальный конструктор дорк-запросов для поиска в Google и Bing.

### Репозитории

- Поиск по аккаунтам и утечкам
...
- Комплексные расследования и мониторинг
  - Robin — OSINT-инструмент, который автоматически собирает и анализирует данные о цели из открытых источников (соцсети, поисковики, сайты и др.), извлекает сведения из медиа и документов и формирует отчёт/досье за минуты. https://github.com/apurvsinghgautam/robin
  - OpenPlanter — open-source AI-агент для расследований по разнородным наборам данных: загружает корпоративные реестры, данные о финансировании кампаний, лоббировании и госконтрактах, сопоставляет сущности и выявляет подтверждённые источниками связи; включает desktop GUI с интерактивным графом знаний, Python CLI/TUI и рекурсивных субагентов. https://github.com/ShinMegamiBoson/OpenPlanter
  - Crucix — локальный self-hosted intelligence terminal/OSINT-dashboard на Node.js: параллельно собирает данные из 27 открытых источников каждые 15 минут, включая NASA FIRMS, авиацию, морской AIS, радиационный мониторинг, спутниковые группировки, экономические индикаторы, рынки, конфликты, санкционные списки, новости и соцсигналы; показывает 3D-глобус/карту, sweep delta, cross-source signals, nuclear/space watch, поддерживает Telegram/Discord-ботов, multi-tier alerts и optional LLM-слой для brief/trade ideas. https://github.com/calesthio/Crucix https://www.crucix.live/
  - OpenCTI — open-source платформа киберразведки (Cyber Threat Intelligence) от Filigran: сбор, хранение, корреляция и визуализация данных об угрозах (TTP, IOC, кампании, инструменты), импорт из множества источников, REST API и GraphQL, интеграция с MITRE ATT&CK, self-hosted, подходит для SOC и CTI-аналитиков. https://github.com/OpenCTI-Platform/opencti https://opencti.io
- Разработка OSINT-инструментов
...
- Netlas Responses — OSINT-сервис для поиска по сигнатурам устройств и просмотра в реальном времени публично доступных (неправильно настроенных) камер наблюдения по всему миру. https://app.netlas.io/responses/
...
- Kepler.gl — мощный open-source инструмент для визуального исследования больших наборов геопространственных данных, поддерживающий различные форматы файлов и обеспечивающий высокопроизводительный рендеринг и анализ данных в браузере. https://kepler.gl/
...
- Skymem (https://www.skymem.info/) — поиск и обнаружение email-адресов, связанных с доменным именем или организацией.
...
- Поиск по фото
  ...
  - FaceAgle — бесплатный сервис распознавания лиц, предназначенный для поиска изображений людей в интернете с использованием технологий facial recognition, характеризующийся переменной точностью результатов (от высокой для известных личностей до низкой для малоизвестных людей), способностью находить профили в социальных сетях включая LinkedIn и Instagram, а также склонностью к генерации большого количества ложноположительных результатов при поиске неизвестных лиц. http://faceagle.com/
  - Sherlock AI Face Search — iOS-приложение для поиска совпадений по фотографии лица в открытых источниках и социальных сетях с использованием ИИ и индексированных изображений; использовать с учётом правовых и privacy-ограничений. https://apps.apple.com/ng/app/sherlock-ai-face-search/id6756683188
- Youtube
  - OSINT инструмент для анализа пользователей YouTube - сервис с базой данных из 20 миллиардов комментариев YouTube от 1,4 миллиарда пользователей (2005-2025), использующий искусственный интеллект Mistral для создания профилей с информацией о местоположении, языках, предпочтениях и политических взглядах комментаторов, предназначенный преимущественно для правоохранительных органов за $20 в месяц. https://www.404media.co/developer-builds-tool-that-scrapes-youtube-comments-uses-ai-to-predict-where-users-live/
- Остальное
  - https://cignalosint.lovable.app/
  - WhatsMyName Web (https://whatsmyname.app/) — поиск учётных записей по имени пользователя или email на сотнях сайтов и сервисов.
  - UserSearch.ai — комплексная OSINT-платформа, объединяющая более 15 премиальных провайдеров данных в едином интерфейсе для проведения расследований по именам пользователей, электронной почте, номерам телефонов, изображениям и другим данным, предлагающая систему внутренних кредитов для доступа к платным внешним инструментам, модули поиска по криптовалютам, анализа угроз, форензики веб-сайтов и мониторинга утечек данных с базовым и премиум-планами подписки. https://UserSearch.ai
...
- Surveillance Watch — интерактивная платформа мониторинга индустрии коммерческого наблюдения, представляющая собой карту с тремя режимами просмотра: базу данных 215 поставщиков услуг слежения (Surveillance as Service), перечень стран-объектов наблюдения и информацию о 98 организациях-финансистах данной отрасли, запущенная в августе 2024 года анонимными разработчиками. https://www.surveillancewatch.io/
