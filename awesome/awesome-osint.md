...
- Hybrid Analysis (https://www.hybrid-analysis.com/?lang=ru&ref=t.me/russian_osint) — песочница от Crowdstrike для анализа файлов.  
...
- Intezer Analyze URL (https://analyze.intezer.com/scan?tab=url&ref=t.me/russian_osint) — анализ ссылок на потенциальные угрозы.  
- Kaspersky Web Address Analysis (https://opentip.kaspersky.com/?tab=web&ref=t.me/russian_osint) — проверка веб-ресурсов от Лаборатории Касперского.  
