...
- Проект "Every Programmer Should Know" — коллекция преимущественно технических ресурсов, которые, по мнению автора, должен знать каждый разработчик программного обеспечения, независимо от уровня навыков или технологического стека. https://github.com/mtdvio/every-programmer-should-know
