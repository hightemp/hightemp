...
- Linux
    ...
    - **Архитектура (Architecture)**
        ...
        - Потоки
            ...
            - Difference Between Process And Thread in Linux https://www.slashroot.in/difference-between-process-and-thread-linux
    ...
    - **Ввод/Вывод (I/O)**
        - Сокеты (Sockets)
            ...
            - SO_REUSEPORT
                ...
                - Когда один TCP-порт может быть поделён https://habr.com/ru/articles/725144/
        ...
        - Остальное
            - Linux Block I/O debugging https://blog.domainmess.org/post/bio_debug/
...
- Администрирование
    ...
    - Linux System Administration Crash Course https://www.youtube.com/watch?v=qAMWG86sEm8
    - Learn Linux - The Full Course https://www.youtube.com/watch?v=v392lEyM29A
- Безопасность
