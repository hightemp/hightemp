...
### Приложения, которые надо попробывать

- приложение для менеджмкнта и хостинга других приложений https://github.com/coollabsio/coolify
...
- https://github.com/TheLocehiliosan/yadm yadm - уникальный менеджер "dotfiles" для управления конфигурационными файлами, основанный на Git, обладающий полным спектром его функций, поддерживающий альтернативные файлы для разных систем или шаблонизированные, а также предлагающий шифрование конфиденциальных данных и настраиваемые возможности инициализации и хуков.
